...
router.put('/:id', async(req, res) =>{
    ...
    {new: true}
     ...
     if (!order)
     return res.status(404).send('the order was not updateed!')
     res.send(order);
})
...
router.delete(`/:id`,(req, res) => {
 ...
 // getting total sales to display 
...
//exporting the router to make it  accesseable from any where in the code
